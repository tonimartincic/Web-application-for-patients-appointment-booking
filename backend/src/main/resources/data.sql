...
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Marko', 'Marković', 'marko.markovic@gmail.com', 'password', 1, '091 331 9087', '10525231193', parsedatetime('09.11.1984', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Mirko', 'Marković', 'mirko.markovic@gmail.com', 'password', 1, '091 096 4519', '74180178817', parsedatetime('19.03.1981', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Petar', 'Zecimir', 'petar.zecimir@gmail.com', 'password', 2, '091 385 9573', '53569680271', parsedatetime('11.06.1972', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Miroslav', 'Puška', 'miroslav.puska@gmail.com', 'password', 3, '098 443 5600', '02851978197', parsedatetime('01.08.2000', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Vladimir', 'Primorac', 'vladimir.primorac@gmail.com', 'password', 4, '095 879 9090', '89362962652', parsedatetime('25.03.1996', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Petra', 'Horvat', 'petra.horvat@gmail.com', 'password', 5, '095 321 5567', '94304389503', parsedatetime('30.07.1990', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Iva', 'Kozar', 'iva.kozar@gmail.com', 'password', 6, '095 443 7096', '82056631214', parsedatetime('13.04.1989', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Leon', 'Lučić', 'leon.lucic@gmail.com', 'password', 7, '095 160 0143', '00669951982', parsedatetime('15.09.1964', 'dd.MM.yyyy'));
Insert into patient (first_name, last_name, mail, password, address_data_id, phone_number, oib, date_of_birth) values ('Mislav', 'Marić', 'mislav.maric@gmail.com', 'password', 29, '095 888 1233', '88132932264', parsedatetime('19.02.1977', 'dd.MM.yyyy'));
...
Insert into referral (referral_type, department_type, patient_id, general_practitioner_id, created_on) values ('ADVISORY_HEALTH_CARE_A1', 'ANESTHESIOLOGY_REANIMATOLOGY_AND_INTENSIVE_CARE', 1, 1, CURRENT_DATE());
